...
class ModelUser:
    ...
    def train_test_model_roc(self, data):
        """
    ...
    def predict(self, no_labels_data):
        ...
        """
        no_labels_data.drop(columns=['transcript_id', 'transcript_position', 'first5', 'second5', 'third5'])
        return self.model.predict(no_labels_data)
    
    def output_model(self, model_name = "default"):
        """
            Puts model into a savedModels file.
            Output:
            None
        """
        dump(self.model, "savedModels/" + model_name)
